function MtrDatepicker(a) {
    ...
    var n, o = {
        ...
        o.disableAmPm && (o.hours.min = 0, o.hours.max = 23), o.minutes.min = void 0 !== a.minutes && void 0 !== a.minutes.min ? parseInt(a.minutes.min) : o.minutes.min, 
        ...
        if (!o.disableAmPm && o.smartHours && 12 === a && e && (d = !0), !o.validateAfter && !d) return void _(o.references.hours);
        ba("hour", "beforeChange", a, c);
        var f = a;
        !o.disableAmPm && a > 12 && (a -= 12), $(o.references.hours, a, b), o.validateAfter && !d ? (_(o.references.hours), 
        setTimeout(function() {
            !o.disableAmPm && c > 12 && (c -= 12), $(o.references.hours, c, b), ba("hour", "onChange", a, c), 
        ...
        N(!1)) : o.disableAmPm || !o.smartHours || 23 !== f && 11 !== f || 12 !== c || e ? o.disableAmPm || o.smartHours || 12 !== f || !e ? p.timestamp = p.date.setHours(f) : p.timestamp = p.date.setHours(0) : (f = 11, 
        p.timestamp = p.date.setHours(f), N(!0)), !o.disableAmPm && f > 12 && (f -= 12, 
        N(!1)), ba("hour", "onChange", a, c), ba("hour", "afterChange", a, c));
    }, K = function() {
