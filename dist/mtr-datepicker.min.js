function MtrDatepicker(a) {
    ...
    var k, l = {
        ...
        s(a), k = b(l.targetElement), k.className += "mtr-datepicker", t(), u();
    }, s = function(a) {
        l.targetElement = a.target, m.date = a.timestamp ? new Date(a.timestamp) : new Date(), 
        m.timestamp = m.date.getTime(), l.animations = void 0 !== a.animations ? a.animations : l.animations, 
        ...
        a = a.replace("H", c(d, f)), a = a.replace("h", d), a = a.replace("mm", b(e)), a = a.replace("m", F()), 
