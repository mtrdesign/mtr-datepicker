function MtrDatepicker(e) {
    function t(e) {
        n = function() {
            ...
            return e;
        }(), u(e) ? (m(e), l = G(c.targetElement), f(), v()) : console.error("Initialization of the datepicker is blocked because of errors in the config.");
    }
    function r(e, t) {
        e = void 0 !== e ? e : z(), t = void 0 !== t ? t : H(), f(e, t), c.datepicker && function(e, t) {
    ...
    var l, c = {
        ...
        l.appendChild(r)), c.datepicker && (s = p({
            name: "months",
        ...
        function s(e, t, a) {
            ...
            n.appendChild(s), n.appendChild(r), s.addEventListener("change", function(e) {
                if (!A(t) && c.future) return A(!t), e.preventDefault(), e.stopPropagation(), !1;
            }, !1), n;
        }
        ...
        a = e, !c.disableAmPm && 12 < e && (e -= 12), L(c.references.hours, e, t), c.validateAfter && !r ? (O(c.references.hours), 
        setTimeout(function() {
            !c.disableAmPm && 12 < n && (n -= 12), L(c.references.hours, n, t), j("hour", "onChange", e, n), 
        ...
        A(!1)) : c.disableAmPm || !c.smartHours || 23 !== a && 11 !== a || 12 !== n || s ? c.disableAmPm || c.smartHours || 12 !== a || !s ? d.timestamp = d.date.setHours(a) : d.timestamp = d.date.setHours(0) : (a = 11, 
        d.timestamp = d.date.setHours(a), A(!0)), !c.disableAmPm && 12 < a && (a -= 12, 
        A(!1)), j("hour", "onChange", e, n), j("hour", "afterChange", e, n))) : O(c.references.hours);
    }, k = function() {
        ...
        c.validateAfter || n ? (j("minute", "beforeChange", e, a), L(c.references.minutes, e, t), 
        c.validateAfter && !n ? (O(c.references.minutes), setTimeout(function() {
            L(c.references.minutes, a, t), j("minute", "onChange", e, a), j("minute", "afterChange", e, a);
        }, c.transitionValidationDelay)) : (d.timestamp = d.date.setMinutes(e), j("minute", "onChange", e, a), 
        j("minute", "afterChange", e, a))) : O(c.references.minutes);
    }, w = function() {
        ...
        c.validateAfter || n ? (j("day", "beforeChange", e, a), L(c.references.dates, e, t), 
        c.validateAfter && !n ? (O(c.references.dates), setTimeout(function() {
            L(c.references.dates, a, t), j("day", "onChange", e, a), j("day", "afterChange", e, a);
        }, c.transitionValidationDelay)) : (d.timestamp = d.date.setDate(e), j("day", "onChange", e, a), 
        j("day", "afterChange", e, a))) : O(c.references.dates);
    }, V = function() {
        return d.date.getDate();
    }, S = function(e, t) {
        var a = d.date.getMonth(), n = x("month", e, a);
        c.validateAfter || n ? (j("month", "beforeChange", e, a), L(c.references.months, e, t), 
        c.validateAfter && !n ? (O(c.references.months), setTimeout(function() {
            L(c.references.months, a, t), j("month", "onChange", e, a), j("month", "afterChange", e, a);
        }, c.transitionValidationDelay)) : (d.timestamp = d.date.setMonth(e), r(e), j("month", "onChange", e, a), 
        j("month", "afterChange", e, a))) : O(c.references.months);
    }, z = function() {
        return d.date.getMonth();
    }, P = function(e, t) {
        var a = d.date.getFullYear(), n = x("year", e, a);
        c.validateAfter || n ? (j("year", "beforeChange", e, a), r(void 0, e), L(c.references.years, e, t), 
        c.validateAfter && !n ? (O(c.references.years), setTimeout(function() {
            L(c.references.years, a, t), j("year", "onChange", e, a), j("year", "afterChange", e, a);
        }, c.transitionValidationDelay)) : (d.timestamp = d.date.setFullYear(e), j("year", "onChange", e, a), 
        j("year", "afterChange", e, a))) : O(c.references.years);
    }, H = function() {
        return d.date.getFullYear();
    }, Y = function(e) {
        var t = W(e);
        d.date = new Date(t), d.timestamp = t;
        var a = d.date.getHours(), n = w(), r = 0 <= a && a < 12, s = V(), i = z(), o = H();
        T(a = 0 === a ? 12 : a), E(n), S(i), P(o), M(s), A(r);
    }, L = function(e, t, a) {
        var n, r, s, i, o, m = G(e);
    ...
    }, this.setHours = T, this.setMinutes = E, this.setAmPm = A, this.setDate = M, this.setMonth = S, 
    this.setYear = P, this.setTimestamp = Y, this.values = d, this.toDateString = $, 
    this.toGMTString = function() {
        ...
        var t = k(), a = w(), n = N(), r = V(), s = z() + 1, i = H(), o = c.utcTimezone.offset;
        function m(e, t, a) {
