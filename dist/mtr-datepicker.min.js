function MtrDatepicker(a) {
    ...
    var n, o = {
        ...
        o.smartHours = void 0 !== a.smartHours ? a.smartHours : o.smartHours, p.date = a.timestamp ? new Date(a.timestamp) : new Date(), 
        p.date.setSeconds(0), o.utcTimezone = void 0 !== a.utcTimezone ? a.utcTimezone : p.date.getTimezoneOffset() / 60 * -1, 
        console.log(o.utcTimezone);
        var b = p.date.getTime() + 60 * p.date.getTimezoneOffset() * 1e3, c = b + 60 * o.utcTimezone * 60 * 1e3;
