function MtrDatepicker(e) {
    ...
    function r(e, t) {
        e = void 0 !== e ? e : P(), t = void 0 !== t ? t : Y(), v(e, t), function(e, t) {
    ...
    var l, c = {
        ...
        var a = d.date.getHours(), n = k(), r = 0 <= a && a < 12, s = S(), i = P(), o = Y();
        E(a = 0 === a ? 12 : a), A(n), z(i), H(o), V(s), D(r);
    }, O = function(e, t, a) {
        var n, r, s, i, o = J(e);
    ...
    }, this.setHours = E, this.setMinutes = A, this.setAmPm = D, this.setDate = V, this.setMonth = z, 
    ...
    this.toGMTString = function() {
        ...
        var t = w(), a = k(), n = I(), r = S(), s = P() + 1, i = Y(), o = c.utcTimezone.offset;
        function m(e, t, a) {
