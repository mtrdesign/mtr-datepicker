function MtrDatepicker(e) {
    ...
    function r(e, t) {
        e = void 0 !== e ? e : z(), t = void 0 !== t ? t : Y(), v(e, t), function(e, t) {
    ...
    var l, c = {
        ...
        n = !1), void 0 === e.minutes.max || q(e.minutes.max) || (console.error("Invalid argument: minutes.max should be a number."), 
        n = !1), void 0 === e.minutes.step || q(e.minutes.step) || (console.error("Invalid argument: minutes.step should be a number."), 
        ...
        n = !1)), e.hours && (void 0 === e.hours.min || q(e.hours.min) || (console.error("Invalid argument: hours.min should be a number."), 
        n = !1), void 0 === e.hours.max || q(e.hours.max) || (console.error("Invalid argument: hours.max should be a number."), 
        n = !1), void 0 === e.hours.step || q(e.hours.step) || (console.error("Invalid argument: hours.step should be a number."), 
        ...
        n = !1)), e.dates && (void 0 === e.dates.min || q(e.dates.min) || (console.error("Invalid argument: dates.min should be a number."), 
        n = !1), void 0 === e.dates.max || q(e.dates.max) || (console.error("Invalid argument: dates.max should be a number."), 
        n = !1), void 0 === e.dates.step || q(e.dates.step) || (console.error("Invalid argument: dates.step should be a number."), 
        ...
        n = !1)), e.months && (void 0 === e.months.min || q(e.months.min) || (console.error("Invalid argument: months.min should be a number."), 
        n = !1), void 0 === e.months.max || q(e.months.max) || (console.error("Invalid argument: months.max should be a number."), 
        n = !1), void 0 === e.months.step || q(e.months.step) || (console.error("Invalid argument: months.step should be a number."), 
        ...
        n = !1)), e.years && (void 0 === e.years.min || q(e.years.min) || (console.error("Invalid argument: years.min should be a number."), 
        n = !1), void 0 === e.years.max || q(e.years.max) || (console.error("Invalid argument: years.max should be a number."), 
        n = !1), void 0 === e.years.step || q(e.years.step) || (console.error("Invalid argument: years.step should be a number."), 
        ...
        n = !1), !n) {
            ...
            R(r, "mtr-error-message"), r.appendChild(document.createTextNode("An error has occurred during the initialization of the datepicker.")), 
            l.appendChild(r);
        }
        return n;
        ...
        o.className = "mtr-input " + i.name, o.style.display = "none", o.addEventListener("blur", function(n) {
            ...
            !function(e, t) {
                var a, n, r, s;
                Q && $ && (a = e.touches[0].clientX, n = e.touches[0].clientY, r = Q - a, s = $ - n, 
                Math.abs(r) > Math.abs(s) || t(0 < s ? 1 : -1), $ = Q = null);
            }(e, function(e) {
                var t = m.parentElement.parentElement, a = U(t, 0 < e ? ".mtr-arrow.up" : ".mtr-arrow.down");
                a.click();
            });
        }, !1), m);
        ...
        i.addEventListener("touchend", e, !1), i.addEventListener("wheel", function(e) {
            ...
            var t = e.target.parentElement.parentElement.parentElement.parentElement, a = (U(t, ".mtr-values"), 
            U(t, ".mtr-input"), U(t, 0 < (e.wheelDeltaY ? e.wheelDeltaY : -1 * e.deltaY) ? ".mtr-arrow.up" : ".mtr-arrow.down"));
        ...
        var a, n = d.date.getHours(), r = C("hour", e, n), s = I();
        !c.disableAmPm && c.smartHours && 12 === e && s && (r = !0), c.validateAfter || r ? (G("hour", "beforeChange", e, n), 
        a = e, !c.disableAmPm && 12 < e && (e -= 12), O(c.references.hours, e, t), c.validateAfter && !r ? (F(c.references.hours), 
        setTimeout(function() {
            !c.disableAmPm && 12 < n && (n -= 12), O(c.references.hours, n, t), G("hour", "onChange", e, n), 
            G("hour", "afterChange", e, n);
        ...
        D(!1)) : c.disableAmPm || !c.smartHours || 23 !== a && 11 !== a || 12 !== n || s ? c.disableAmPm || c.smartHours || 12 !== a || !s ? d.timestamp = d.date.setHours(a) : d.timestamp = d.date.setHours(0) : (a = 11, 
        d.timestamp = d.date.setHours(a), D(!0)), !c.disableAmPm && 12 < a && (a -= 12, 
        D(!1)), G("hour", "onChange", e, n), G("hour", "afterChange", e, n))) : F(c.references.hours);
    }, A = function() {
        ...
        c.validateAfter || n ? (G("minute", "beforeChange", e, a), c.defaultValues.minutes, 
        ...
        G("minute", "afterChange", e, a))) : F(c.references.minutes);
    }, k = function() {
        ...
        var a, n, r, s, i;
        c.disableAmPm || ((a = U(J(e), "form")).ampm.value = t ? "1" : "0", n = t ? "AM" : "PM", 
        r = U(a, 'input.mtr-input[type="radio"][value="1"]'), s = U(a, 'input.mtr-input[type="radio"][value="0"]'), 
        i = U(a, 'label[for="' + c.targetElement + "-radio-ampm-" + n + '"]'), U(i, "checkbox"), 
        ...
        var a = d.date.getHours(), n = k(), r = 0 <= a && a < 12, s = S(), i = z(), o = Y();
        E(a = 0 === a ? 12 : a), w(n), P(i), H(o), V(s), D(r);
    }, O = function(e, t, a) {
        var n, r, s, i, o = J(e);
        a = a || !1, o && (n = U(o, ".mtr-content"), r = U(o, '.mtr-values .mtr-default-value[data-value="' + t + '"]'), 
        s = U(o, ".mtr-arrow.up"), i = U(o, ".mtr-input"), scrollTo = function(e, t) {
            if (e && t) return t.offsetTop - e.offsetTop;
            return 0;
        }(n, r) + s.clientHeight, i.value = t, i.setAttribute("data-old-value", t), !1 === c.animations || a ? r.scrollIntoView() : W(n, scrollTo, c.transitionDelay));
    }, F = function(e) {
    ...
    }, this.setHours = E, this.setMinutes = w, this.setAmPm = D, this.setDate = V, this.setMonth = P, 
    this.setYear = H, this.setTimestamp = L, this.values = d, this.toDateString = _, 
    this.toGMTString = function() {
        ...
        var t = A(), a = k(), n = I(), r = S(), s = z() + 1, i = Y(), o = c.utcTimezone.offset;
        function m(e, t, a) {
        ...
        e = m(e, "h", t), e = m(e, "mm", u(a)), e = m(e, "m", k()), e = m(e, "a", n ? "am" : "pm"), 
