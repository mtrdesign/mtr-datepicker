function MtrDatepicker(a) {
    ...
    var k, l = {
        ...
        function f() {
            ...
            b.addEventListener("blur", function(c) {
                function d() {
                    ...
                    if ("dates" === a.name && (f = "day"), console.log("target: " + f), l.future && !C(f, d, e)) return console.log("Prevent the change"), 
                    "months" === a.name && e++, b.value = e, void b.focus();
        ...
        U(l.references.months, a, b), V("month", "onChange", a, c), void V("month", "afterChange", a, c)) : (console.log("Change of the month is prevented"), 
        !1);
    }, O = function() {
