function MtrDatepicker(a) {
    ...
    var n, o = {
        ...
        if (q = m(), !x(a)) return void console.error("Initialization of the datepicker is blocked because of erros in the config.");
        w(a), n = b(o.targetElement), z(), A(), y();
    }, w = function(a) {
        ...
        function b(a, b, c) {
            ...
            d.appendChild(f), d.appendChild(e), f.addEventListener("change", function(a) {
                if (!N(b) && o.future) return N(!b), a.preventDefault(), a.stopPropagation(), !1;
            }, !1), d;
        }
        ...
        K();
        return P() !== a && (1 == a && c >= 12 ? (c -= 12, p.timestamp = p.date.setHours(c)) : 0 == a && c < 12 && (c += 12, 
        ...
        if (!o.validateAfter && !d) return void _(o.references.dates);
        ba("day", "beforeChange", a, c), $(o.references.dates, a, b), o.validateAfter && !d ? (_(o.references.dates), 
        setTimeout(function() {
        ...
        if (!o.validateAfter && !d) return void _(o.references.months);
        ba("month", "beforeChange", a, c), $(o.references.months, a, b), o.validateAfter && !d ? (_(o.references.months), 
        setTimeout(function() {
        ...
        if (!o.validateAfter && !d) return void _(o.references.years);
        ba("year", "beforeChange", a, c), F(void 0, a), $(o.references.years, a, b), o.validateAfter && !d ? (_(o.references.years), 
        setTimeout(function() {
        ...
        var c = p.date.getHours(), d = M(), e = c >= 0 && c < 12, f = S(), g = U(), h = W();
