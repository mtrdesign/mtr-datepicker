function MtrDatepicker(a) {
    ...
    var k, l = {
        ...
        function f() {
            ...
            return b.value = a.value, b.className = "input " + a.name, b.style.display = "none", 
        ...
        return d.appendChild(e), d.appendChild(f), d.ampm.value = m.am ? "1" : "0", c.appendChild(d), 
        c;
    }, x = function(a) {
        var b = e("div");
        return b.className = "values", a.values.forEach(function(c) {
            ...
            var b, d = a.target, e = d.parentElement.parentElement.parentElement.parentElement, f = a.wheelDeltaY;
        ...
        var g = b(a);
        f = f || !1;
        var h = c(g, ".content"), i = c(g, '.values .default-value[data-value="' + e + '"]'), j = c(g, ".input");
        scrollTo = d(h, i), j.value = e, j.setAttribute("data-old-value", e), l.animations === !1 || f ? i.scrollIntoView() : U(h, scrollTo, l.transitionDelay);
    }, T = function(a, b) {
