function MtrDatepicker(a) {
    ...
    var k, l = {
        ...
        var b = D(), c = F(), d = O();
        return a = a.replace("M", M() + 1), a = a.replace("D", K()), a = a.replace("YYYY", d), 
        a = a.replace("YY", d.toString().substr(2)), a = a.replace("Y", d), a = a.replace("hh", 9 >= b ? "0" + b : b), 
        a = a.replace("h", b), a = a.replace("mm", 0 >= b ? "0" + c : c), a = a.replace("m", F()), 
        a = a.replace("a", H() ? "am" : "pm"), a = a.replace("A", H() ? "AM" : "PM");
    }, da = function(a, b) {
        o.onChange[a].push(b);
    }, ea = function(a, b) {
