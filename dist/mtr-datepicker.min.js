function MtrDatepicker(a) {
    ...
    var k, l = {
        ...
        function f() {
            ...
            b.addEventListener("blur", function(c) {
                function d() {
                    ...
                    if (b.className.indexOf("months") > -1 && d--, B(a.name, d) === !1) return b.value = b.getAttribute("data-old-value"), 
                    void b.focus();
        ...
        C("month", a, c) && (V("month", "beforeChange", a, c), A(a), m.timestamp = m.date.setMonth(a), 
        U(l.references.months, a, b), V("month", "onChange", a, c), V("month", "afterChange", a, c));
    }, O = function() {
        return m.date.getMonth();
    }, P = function(a, b) {
        var c = m.date.getFullYear();
        C("year", a, c) && (V("year", "beforeChange", a, c), A(void 0, a), m.timestamp = m.date.setFullYear(a), 
        U(l.references.years, a, b), V("year", "onChange", a, c), V("year", "afterChange", a, c));
    }, Q = function() {
